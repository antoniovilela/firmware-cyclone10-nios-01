...
module processor_mm_interconnect_0 (
		...
		output wire [1:0]  SEG_EN_s1_address,                              //                                SEG_EN_s1.address
		output wire        SEG_EN_s1_write,                                //                                         .write
		input  wire [31:0] SEG_EN_s1_readdata,                             //                                         .readdata
		output wire [31:0] SEG_EN_s1_writedata,                            //                                         .writedata
		output wire        SEG_EN_s1_chipselect,                           //                                         .chipselect
	...
	wire  [92:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> LED_s1_agent:cp_data
	...
	wire  [31:0] seg_en_s1_agent_m0_readdata;                                                        // SEG_EN_s1_translator:uav_readdata -> SEG_EN_s1_agent:m0_readdata
	wire         seg_en_s1_agent_m0_waitrequest;                                                     // SEG_EN_s1_translator:uav_waitrequest -> SEG_EN_s1_agent:m0_waitrequest
	wire         seg_en_s1_agent_m0_debugaccess;                                                     // SEG_EN_s1_agent:m0_debugaccess -> SEG_EN_s1_translator:uav_debugaccess
	wire  [16:0] seg_en_s1_agent_m0_address;                                                         // SEG_EN_s1_agent:m0_address -> SEG_EN_s1_translator:uav_address
	wire   [3:0] seg_en_s1_agent_m0_byteenable;                                                      // SEG_EN_s1_agent:m0_byteenable -> SEG_EN_s1_translator:uav_byteenable
	wire         seg_en_s1_agent_m0_read;                                                            // SEG_EN_s1_agent:m0_read -> SEG_EN_s1_translator:uav_read
	wire         seg_en_s1_agent_m0_readdatavalid;                                                   // SEG_EN_s1_translator:uav_readdatavalid -> SEG_EN_s1_agent:m0_readdatavalid
	wire         seg_en_s1_agent_m0_lock;                                                            // SEG_EN_s1_agent:m0_lock -> SEG_EN_s1_translator:uav_lock
	wire  [31:0] seg_en_s1_agent_m0_writedata;                                                       // SEG_EN_s1_agent:m0_writedata -> SEG_EN_s1_translator:uav_writedata
	wire         seg_en_s1_agent_m0_write;                                                           // SEG_EN_s1_agent:m0_write -> SEG_EN_s1_translator:uav_write
	wire   [2:0] seg_en_s1_agent_m0_burstcount;                                                      // SEG_EN_s1_agent:m0_burstcount -> SEG_EN_s1_translator:uav_burstcount
	wire         seg_en_s1_agent_rf_source_valid;                                                    // SEG_EN_s1_agent:rf_source_valid -> SEG_EN_s1_agent_rsp_fifo:in_valid
	wire  [93:0] seg_en_s1_agent_rf_source_data;                                                     // SEG_EN_s1_agent:rf_source_data -> SEG_EN_s1_agent_rsp_fifo:in_data
	wire         seg_en_s1_agent_rf_source_ready;                                                    // SEG_EN_s1_agent_rsp_fifo:in_ready -> SEG_EN_s1_agent:rf_source_ready
	wire         seg_en_s1_agent_rf_source_startofpacket;                                            // SEG_EN_s1_agent:rf_source_startofpacket -> SEG_EN_s1_agent_rsp_fifo:in_startofpacket
	wire         seg_en_s1_agent_rf_source_endofpacket;                                              // SEG_EN_s1_agent:rf_source_endofpacket -> SEG_EN_s1_agent_rsp_fifo:in_endofpacket
	wire         seg_en_s1_agent_rsp_fifo_out_valid;                                                 // SEG_EN_s1_agent_rsp_fifo:out_valid -> SEG_EN_s1_agent:rf_sink_valid
	wire  [93:0] seg_en_s1_agent_rsp_fifo_out_data;                                                  // SEG_EN_s1_agent_rsp_fifo:out_data -> SEG_EN_s1_agent:rf_sink_data
	wire         seg_en_s1_agent_rsp_fifo_out_ready;                                                 // SEG_EN_s1_agent:rf_sink_ready -> SEG_EN_s1_agent_rsp_fifo:out_ready
	wire         seg_en_s1_agent_rsp_fifo_out_startofpacket;                                         // SEG_EN_s1_agent_rsp_fifo:out_startofpacket -> SEG_EN_s1_agent:rf_sink_startofpacket
	wire         seg_en_s1_agent_rsp_fifo_out_endofpacket;                                           // SEG_EN_s1_agent_rsp_fifo:out_endofpacket -> SEG_EN_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> SEG_EN_s1_agent:cp_valid
	wire  [92:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> SEG_EN_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // SEG_EN_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [7:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> SEG_EN_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> SEG_EN_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> SEG_EN_s1_agent:cp_endofpacket
	...
	wire  [16:0] seg_s1_agent_m0_address;                                                            // SEG_s1_agent:m0_address -> SEG_s1_translator:uav_address
	...
	wire  [93:0] seg_s1_agent_rf_source_data;                                                        // SEG_s1_agent:rf_source_data -> SEG_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] seg_s1_agent_rsp_fifo_out_data;                                                     // SEG_s1_agent_rsp_fifo:out_data -> SEG_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> SEG_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // SEG_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [7:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> SEG_s1_agent:cp_channel
	...
	wire  [92:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> SW_s1_agent:cp_data
	...
	wire  [92:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> uart_0_s1_agent:cp_data
	...
	wire  [92:0] led_s1_agent_rp_data;                                                               // LED_s1_agent:rp_data -> router_005:sink_data
	...
	wire         seg_en_s1_agent_rp_valid;                                                           // SEG_EN_s1_agent:rp_valid -> router_006:sink_valid
	wire  [92:0] seg_en_s1_agent_rp_data;                                                            // SEG_EN_s1_agent:rp_data -> router_006:sink_data
	wire         seg_en_s1_agent_rp_ready;                                                           // router_006:sink_ready -> SEG_EN_s1_agent:rp_ready
	wire         seg_en_s1_agent_rp_startofpacket;                                                   // SEG_EN_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         seg_en_s1_agent_rp_endofpacket;                                                     // SEG_EN_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [92:0] seg_s1_agent_rp_data;                                                               // SEG_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [92:0] sw_s1_agent_rp_data;                                                                // SW_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [92:0] uart_0_s1_agent_rp_data;                                                            // uart_0_s1_agent:rp_data -> router_009:sink_data
	...
	wire         seg_en_s1_agent_rdata_fifo_src_valid;                                               // SEG_EN_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] seg_en_s1_agent_rdata_fifo_src_data;                                                // SEG_EN_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         seg_en_s1_agent_rdata_fifo_src_ready;                                               // avalon_st_adapter_004:in_0_ready -> SEG_EN_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> SEG_EN_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> SEG_EN_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // SEG_EN_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> SEG_EN_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) seg_en_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (seg_en_s1_agent_m0_address),                     // avalon_universal_slave_0.address
		.uav_burstcount         (seg_en_s1_agent_m0_burstcount),                  //                         .burstcount
		.uav_read               (seg_en_s1_agent_m0_read),                        //                         .read
		.uav_write              (seg_en_s1_agent_m0_write),                       //                         .write
		.uav_waitrequest        (seg_en_s1_agent_m0_waitrequest),                 //                         .waitrequest
		.uav_readdatavalid      (seg_en_s1_agent_m0_readdatavalid),               //                         .readdatavalid
		.uav_byteenable         (seg_en_s1_agent_m0_byteenable),                  //                         .byteenable
		.uav_readdata           (seg_en_s1_agent_m0_readdata),                    //                         .readdata
		.uav_writedata          (seg_en_s1_agent_m0_writedata),                   //                         .writedata
		.uav_lock               (seg_en_s1_agent_m0_lock),                        //                         .lock
		.uav_debugaccess        (seg_en_s1_agent_m0_debugaccess),                 //                         .debugaccess
		.av_address             (SEG_EN_s1_address),                              //      avalon_anti_slave_0.address
		.av_write               (SEG_EN_s1_write),                                //                         .write
		.av_readdata            (SEG_EN_s1_readdata),                             //                         .readdata
		.av_writedata           (SEG_EN_s1_writedata),                            //                         .writedata
		.av_chipselect          (SEG_EN_s1_chipselect),                           //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (seg_en_s1_agent_m0_address),                     //              m0.address
		.m0_burstcount           (seg_en_s1_agent_m0_burstcount),                  //                .burstcount
		.m0_byteenable           (seg_en_s1_agent_m0_byteenable),                  //                .byteenable
		.m0_debugaccess          (seg_en_s1_agent_m0_debugaccess),                 //                .debugaccess
		.m0_lock                 (seg_en_s1_agent_m0_lock),                        //                .lock
		.m0_readdata             (seg_en_s1_agent_m0_readdata),                    //                .readdata
		.m0_readdatavalid        (seg_en_s1_agent_m0_readdatavalid),               //                .readdatavalid
		.m0_read                 (seg_en_s1_agent_m0_read),                        //                .read
		.m0_waitrequest          (seg_en_s1_agent_m0_waitrequest),                 //                .waitrequest
		.m0_writedata            (seg_en_s1_agent_m0_writedata),                   //                .writedata
		.m0_write                (seg_en_s1_agent_m0_write),                       //                .write
		.rp_endofpacket          (seg_en_s1_agent_rp_endofpacket),                 //              rp.endofpacket
		.rp_ready                (seg_en_s1_agent_rp_ready),                       //                .ready
		.rp_valid                (seg_en_s1_agent_rp_valid),                       //                .valid
		.rp_data                 (seg_en_s1_agent_rp_data),                        //                .data
		.rp_startofpacket        (seg_en_s1_agent_rp_startofpacket),               //                .startofpacket
		...
		.rf_sink_ready           (seg_en_s1_agent_rsp_fifo_out_ready),             //         rf_sink.ready
		.rf_sink_valid           (seg_en_s1_agent_rsp_fifo_out_valid),             //                .valid
		.rf_sink_startofpacket   (seg_en_s1_agent_rsp_fifo_out_startofpacket),     //                .startofpacket
		.rf_sink_endofpacket     (seg_en_s1_agent_rsp_fifo_out_endofpacket),       //                .endofpacket
		.rf_sink_data            (seg_en_s1_agent_rsp_fifo_out_data),              //                .data
		.rf_source_ready         (seg_en_s1_agent_rf_source_ready),                //       rf_source.ready
		.rf_source_valid         (seg_en_s1_agent_rf_source_valid),                //                .valid
		.rf_source_startofpacket (seg_en_s1_agent_rf_source_startofpacket),        //                .startofpacket
		.rf_source_endofpacket   (seg_en_s1_agent_rf_source_endofpacket),          //                .endofpacket
		.rf_source_data          (seg_en_s1_agent_rf_source_data),                 //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),              //                .error
		.rdata_fifo_src_ready    (seg_en_s1_agent_rdata_fifo_src_ready),           //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (seg_en_s1_agent_rdata_fifo_src_valid),           //                .valid
		.rdata_fifo_src_data     (seg_en_s1_agent_rdata_fifo_src_data),            //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) seg_en_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (seg_en_s1_agent_rf_source_data),                 //        in.data
		.in_valid          (seg_en_s1_agent_rf_source_valid),                //          .valid
		.in_ready          (seg_en_s1_agent_rf_source_ready),                //          .ready
		.in_startofpacket  (seg_en_s1_agent_rf_source_startofpacket),        //          .startofpacket
		.in_endofpacket    (seg_en_s1_agent_rf_source_endofpacket),          //          .endofpacket
		.out_data          (seg_en_s1_agent_rsp_fifo_out_data),              //       out.data
		.out_valid         (seg_en_s1_agent_rsp_fifo_out_valid),             //          .valid
		.out_ready         (seg_en_s1_agent_rsp_fifo_out_ready),             //          .ready
		.out_startofpacket (seg_en_s1_agent_rsp_fifo_out_startofpacket),     //          .startofpacket
		.out_endofpacket   (seg_en_s1_agent_rsp_fifo_out_endofpacket),       //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	processor_mm_interconnect_0_router_002 router_006 (
		.sink_ready         (seg_en_s1_agent_rp_ready),                       //      sink.ready
		.sink_valid         (seg_en_s1_agent_rp_valid),                       //          .valid
		.sink_data          (seg_en_s1_agent_rp_data),                        //          .data
		.sink_startofpacket (seg_en_s1_agent_rp_startofpacket),               //          .startofpacket
		.sink_endofpacket   (seg_en_s1_agent_rp_endofpacket),                 //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (seg_en_s1_agent_rdata_fifo_src_data),            //     in_0.data
		.in_0_valid     (seg_en_s1_agent_rdata_fifo_src_valid),           //         .valid
		.in_0_ready     (seg_en_s1_agent_rdata_fifo_src_ready),           //         .ready
